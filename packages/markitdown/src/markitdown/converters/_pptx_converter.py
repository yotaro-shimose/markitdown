        ...
        for slide in presentation.slides:
            ...
            def get_shape_content(shape, **kwargs):
                ...
                if self._is_picture(shape):
                    ...
                    keep_data_uri = kwargs.get("keep_data_uris", False)
                    image_dir = kwargs.get("img_dir")
                    if keep_data_uri and image_dir is not None:
                        raise ValueError(
                            "Cannot specify both keep_data_uris and image_dir"
                        )
                    if keep_data_uri:
